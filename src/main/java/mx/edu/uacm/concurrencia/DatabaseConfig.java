...
public class DatabaseConfig {
	...
	// bean post processor
	// Nos aqyudara a relanzar una serie de excepciones a nivel de base datos a
	// traves de las distintas capas
	...
	/*
	 * En una relacion muchoa a muchos, existen atributos que no encagan en ninguna
	 * de las dos entidades, ese atributo puede ser parte de la relacion lo primerop
	 * que se tiene que hacer es crear una relacion con el nombre de la asociacion
	 * 2. crear una pk_compuesta que es una clase, que asocia a la per con la
	 * direccion,
	 */
